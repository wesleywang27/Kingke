...
Meteor.startup(() => {
  ...
  Router.route('/setgroup', function () {
    ...
    try {
      ...
      var group_data = '{"openid":"o0XCywkF-5S1fWSlQ4S2qctr9wt4","to_groupid":103}';
      var group_result = HTTP.post(group_url,{content: group_data});
      res.end("set_success" + group_result.content);
    }catch (err){
      res.end("network error " + err);
  ...
  Router.route('/setmenu', function () {
    ...
    try {
      ...
      var menu_data = '{"button":[{"name":"课程","sub_button":[{"type":"view","name":"课程列表","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2Fcourse_list&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"},{"type":"view","name":"我的课程","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2Fmy_course_list&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"},{"type":"view","name":"课程动态","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2Fnotice_list&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"}]}, {"name":"群组","sub_button":[{"type":"view","name":"课程群组","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2#&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"},{"type":"view","name":"个人群组","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2F#&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"},{"type":"view","name":"创建群组","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2F#&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"}]},{"name":"个人中心","sub_button":[{"type":"view","name":"课程表","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2Fcontact_list&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"}, {"type":"view","name":"联系人","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2Finfo&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"}, {"type":"view","name":"我的名片","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2Finfo&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"}]}],"matchrule":{"group_id":"103"}}';
