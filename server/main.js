...
Meteor.startup(() => {
  ...
  Router.route('/setmenu', function () {
    ...
    try {
      ...
      var menu_data = '{"button":[{"name":"课程"}, {"name":"群组"}, {"name":"个人中心","sub_button":[{"type":"view","name":"个人信息","url":"https://open.weixin.qq.com/connect/oauth2/authorize?appid=' + config.appID + '&redirect_uri=http%3A%2F%2F' + config.url + '%2Fregist&response_type=code&scope=snsapi_userinfo&state=lc#wechat_redirect"}]}],"matchrule":{"group_id":"100"}}';
